...
NEXT_PUBLIC_STRIPE_PRO_MONTHLY_PLAN_ID= NEXT_PUBLIC_STRIPE_PRO_YEARLY_PLAN_ID=
...
Let's check the configuration part for update all environment variables before
use `pnpm run dev`.
