...
If you'd like to build and add your own custom components, see the
[Custom Components](#custom-components) section below.
...
You can add your own custom components using the `components` props from
`useMDXComponent`.
...
This will overwrite the `<hr />` tag or `---` in Mardown with the HTML output
above.
...
Make sure you have configured the path to your content in your
